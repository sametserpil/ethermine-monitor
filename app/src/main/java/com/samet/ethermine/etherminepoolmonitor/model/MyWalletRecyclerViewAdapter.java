...
import com.samet.ethermine.etherminepoolmonitor.fragments.dummy.DummyContent.DummyItem;
...
public class MyWalletRecyclerViewAdapter extends RecyclerView.Adapter<MyWalletRecyclerViewAdapter.ViewHolder> {
    ...
    public MyWalletRecyclerViewAdapter(List<DummyItem> items) {
        mValues = items;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_wallets, parent, false);
